...
class RefundPurchaseRequest extends AbstractRequest
{
    private const ENDPOINT_METHOD = 'payments/{id}/refunds';
    ...
    {
        return $this->response = new RefundPurchaseResponse($this, $bodyContents, $headers, $statusCode);
    }
