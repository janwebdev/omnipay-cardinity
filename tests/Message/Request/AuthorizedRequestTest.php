...
class AuthorizedRequestTest extends AbstractRequestTest
{
	private AbstractRequest $request;

	protected function setUp(): void
	{
		$this->request = $this->makeRequest(AuthorizedRequest::class);
	}
	 ...
	 * @param AuthorizedRequest $purchaseRequest
	 */
	public function testHttpMethodIsPost(AuthorizedRequest $purchaseRequest): void
	{
	 ...
	 * @param AuthorizedRequest $purchaseRequest
	 */
	public function testDataInstances(AuthorizedRequest $purchaseRequest): void
	{
